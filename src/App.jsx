...
import githubLogo from './assets/github-desktop.svg'
import './App.css'
      ...
      case 0:
        return (
          <section id="center">
            ...
            <p style={{maxWidth: 600, margin: '24px auto 0', textAlign: 'center'}}>Welcome to my portfolio!<br></br>
              Here you can learn more about me, my work, and download my resume. I am an aspiring engineer looking to make a positive impact in the world through innovative solutions and creative problem-solving.</p>
          </section>
        );
      case 1:
        return (
          <section id="center">
            ...
            <h2 style={{marginTop: 32, textAlign: 'center'}}>Coding</h2>
            <div className="badge-paragraph-flex">
              <a id="badge-link" href="https://github.com/rfryrice"> 
                <img src={githubLogo} alt="Github Icon" style={{ display: 'flex', margin: 0, width: 'auto', height: 'auto' }} />
              </a>
              <p style={{margin: '0 10px', textAlign: 'left'}}>I have experience with Python, JavaScript, and C++. I enjoy coding and am always looking to learn new languages and frameworks. I have a passion for problem-solving and enjoy working on projects that challenge me to think creatively and critically.</p>
            </div>
          </section>
        );
      case 2:
